    ...
    <Container>
      <Content>
        <TitleWrap>
          ...
          <TextWrap>
            <Text>
              Ми відтворили легендарний зошит Левка Лук’яненка разом із
              палітуркою та чернеткою Акта проголошення незалежності України на
              другій сторінці. Все так само, як було 34 роки тому, тільки з
              чистими сторінками — для ваших ідей, конспектів і текстів, які,
              можливо, одного дня теж змінять долю країни. Наклад «Зошита
              Незалежності» обмежений і має благодійну мету: весь прибуток буде
              переданий ГО «Азов.Супровід» на підтримку звільнених із полону
