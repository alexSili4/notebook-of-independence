    ...
    <ChronicleSectionContentStepContainer>
      ...
      <TextWrap>
        ...
        <TitleWrap>
          ...
          <Text>
            Левко Лукʼяненко у присутності Леонтія Сандуляка написав чернетку
            Акта проголошення незалежності за півтори години. У звичайному
            учнівському зошиті, кульковою ручкою.
          </Text>
        </TitleWrap>
      </TextWrap>
    </ChronicleSectionContentStepContainer>
