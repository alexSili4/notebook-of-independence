    ...
    <Container>
      <Desc>
        ...
        <DescText>
          ...
          <br />
          Термін доставки: 2–5 робочих днів після підтвердження оплати. Також
          придбати Зошит незалежності можна в мережі супермаркетів «Сільпо», або
          ж замовити на сайті чи в мобільному застосунку.
        </DescText>
      </Desc>
      <Desc>
        <PackageIcon />
